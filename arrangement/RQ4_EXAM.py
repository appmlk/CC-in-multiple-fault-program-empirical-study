...
# def getFileSmallExam(faultID,filePath,faultPath):
#     if os.path.exists(filePath):
#         f = open(filePath, 'rb')
#         content = pickle.load(f)
#         f.close()
...
#     else:
#         print(filePath)
#     faultindex=faultcontent.index(int(faultID))
#     minvalue=-1
#     # for key in content:
#     #     if content[key][3]<minvalue or minvalue==-1:
#     #         minvalue=content[key][3]
#     minvalue = content[faultindex][3]
#     return minvalue
...
def getSmallExam(MFverionPath):
    ...
    for formula in formulaList:
        ...
        for strategy in strategyList:
            ...
            # filename_CC_fault = "fault_coverage_cc_v1_"+strategy+"_" + formula
...
if __name__ == "__main__":
    ...
    ExamSmallResult={}
    TopResult={}
    ExamSmallResultPath=os.path.join(rootPath,"ExamBigResult_isolation_Score.txt")
